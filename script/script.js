...
const startButton = document.querySelector('.start-button'),
      ...
      // switcherInput = document.querySelectorAll('.calc-handler'),
      // switcherSpan = document.querySelectorAll('.checkbox-label'),
...
// [].forEach.call(switcherInput, (e)=>{
//   if (switcherInput.checked) {
//     switcherSpan.textContent = 'Да';
//     console.log('good')
//   } else {
//     switcherSpan.textContent = 'Нет';
//     console.log('bad')
//   }
// });

// switcherInput.onchange = () => {
//   if (switcherInput.checked) {
//     switcherSpan.textContent = 'Да';
//   } else if (switcherInput.unchecked) {
//     switcherSpan.textContent = 'Нет';
//   }
// }

// switcherInput.forEach(function(switcherInput) {
//   if (switcherInput.checked) {
//     switcherSpan.textContent = 'Да'
//   } else {
//     switcherSpan.textContent = 'Нет'
